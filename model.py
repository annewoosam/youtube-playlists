...
class Playlist(db.Model):
    ...
    def __repr__(self):
        return f'<Playlist channel_name={self.channel_name} playlist_name={self.playlist_name}>'

def connect_to_db(flask_app, db_uri='postgresql:///youtube_playlists', echo=True):
